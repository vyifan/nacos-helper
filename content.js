(function () {
  ...
  function initNacosHelper() {
    ...
    fullscreenToolbar.style.bottom = '30px';
    ...
    fullscreenToolbar.style.gap = '15px';
    fullscreenToolbar.style.backgroundColor = 'rgba(255, 255, 255, 0.95)';
    fullscreenToolbar.style.padding = '10px 15px';
    fullscreenToolbar.style.borderRadius = '8px';
    fullscreenToolbar.style.boxShadow = '0 4px 15px rgba(0, 0, 0, 0.2)';
